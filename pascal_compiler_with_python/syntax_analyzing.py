...
class SyntaxAnalyzer:
    ...
    def __sd_type(self):
        if self.currentToken._getName() in ['tk_string_type', 'tk_int_type', 
                    'tk_bool_type', 'tk_real_type']:
            self.__nextToken()
            return True
        self.__error()
    ...
    def __rel_op(self) -> bool:
        if self.currentToken._getName() in ['tk_eq', 'tk_ne', 'tk_lt', 'tk_gt', 'tk_le', 'tk_ge', 'tk_in']:
            self.__nextToken()
            return True
        return False
